...
<nav class="navbar ks-navbar">
    ...
    <div href="index.html" class="navbar-brand">
        ...
        <div class="ks-navbar-logo">
            <a href="index.html" class="ks-logo"><img src="{{asset('assets/backend/images/admin-logo.gif')}}" alt="Logo" class="logo_img">
            </a>
                                ...
                                <div class="ks-wrapper ks-scrollable">
                                    <a href="#" class="ks-message">
                                        <div class="ks-avatar ks-online">
                                            <img src="{{asset('assets/backend/images/avatars/avatar-1.jpg')}}" width="36" height="36">
                                        </div>
                                        <div class="ks-info">
                                    ...
                                    <a href="#" class="ks-message">
                                        <div class="ks-avatar ks-online">
                                            <img src="{{asset('assets/backend/images/avatars/avatar-5.jpg')}}" width="36" height="36">
                                        </div>
                                        <div class="ks-info">
                                            <div class="ks-user-name">Emily Carter</div>
                                            <div class="ks-text">In golf, Danny Willett (pictured) wins the M...</div>
                                    ...
                                    <a href="#" class="ks-message">
                                        <div class="ks-avatar ks-offline">
                                            <img src="{{asset('assets/backend/images/avatars/placeholders/ava-36.png')}}" width="36" height="36">
                                        </div>
                                        <div class="ks-info">
                                            <div class="ks-user-name">Emily Carter</div>
                                            <div class="ks-text">In golf, Danny Willett (pictured) wins the M...</div>
                                    ...
                                    <a href="#" class="ks-message">
                                        <div class="ks-avatar ks-offline">
                                            <img src="{{asset('assets/backend/images/avatars/avatar-4.jpg')}}" width="36" height="36">
                                        </div>
                                        <div class="ks-info">
                                            <div class="ks-user-name">Emily Carter</div>
                                            <div class="ks-text">In golf, Danny Willett (pictured) wins the M...</div>
                            ...
                            <div class="tab-pane ks-notifications-tab active" id="navbar-notifications-all" role="tabpanel">
                                <div class="ks-wrapper ks-scrollable">
                                    <a href="#" class="ks-notification">
                                        <div class="ks-avatar">
                                            <img src="{{asset('assets/backend/images/avatars/avatar-3.jpg')}}" width="36" height="36">
                                        </div>
                                        <div class="ks-info">
                ...
                <div class="nav-item dropdown ks-user">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                        <span class="ks-avatar">
                            <img src="{{asset('assets/backend/images/avatars/avatar-13.jpg')}}" width="36" height="36">
                        </span>
                        <span class="ks-info">
