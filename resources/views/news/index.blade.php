            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="breadcrumbs">
                        <ul>
                            <li><a href="{{route('news',['tournament'=>$tournament->id])}}">Home</a></li>
                            <li>News</li>
                    ...
                    <div class="panel-box">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="img-hover">
                                        ...
                                        <div class="overlay"><a href="{{route('news-detail',['tournamentId'=>$tournament->id])}}">+</a></div>
                                    </div>
                                </div>
                                <div clas
                                     s="col-md-8">
                                    <h5><a href = "{{route('news-detail',['tournamentId'=>$tournament->id])}}">Group Stage Breakdown</a></h5>
                                    <span class="data-info">January 3, 2014  / <i class="fa fa-comments"></i><a href="#">0</a></span>
                                    <p>While familiar with fellow European nation France, Hareide admits that South American side Peru.<a href = "{{route('news-detail',['tournamentId'=>$tournament->id])}}">Read More [+]</a></p>
                                </div>
                            </div>
                        </div>
                        <!-- End Post Item -->
                        ...
                        <div class="post-item">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <h5><a href = "{{route('news-detail',['tournamentId'=>$tournament->id])}}">Russia 2018’s potential classic match-ups</a></h5>
                                    <span class="data-info">January 9, 2014  / <i class="fa fa-comments"></i><a href="#">5</a></span>
                                    <p>Our goal is very clear, it didn’t change after the draw. We should qualify for the knockout stage.<a href = "{{route('news-detail',['tournamentId'=>$tournament->id])}}">Read More [+]</a></p>
                                </div>
                            </div>
                        </div>
                        <!-- End Post Item -->
                        ...
                        <div class="post-item">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <h5><a href = "{{route('news-detail',['tournamentId'=>$tournament->id])}}">World Cup rivalries reprised</a></h5>
                                    <span class="data-info">January  4, 2014  / <i class="fa fa-comments"></i><a href="#">3</a></span>
                                    <p>The outdoor exhibition on Manezhnaya Square comprises 11 figures that symbolise the main sites of interest.<a href = "{{route('news-detail',['tournamentId'=>$tournament->id])}}">Read More [+]</a></p>
                                </div>
                            </div>
                        </div>
                        <!-- End Post Item -->
                        ...
                        <div class="post-item">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <h5><a href = "{{route('news-detail',['tournamentId'=>$tournament->id])}}">All set for your trip to Russia?</a></h5>
                                    <span class="data-info">January 8, 2014  / <i class="fa fa-comments"></i><a href="#">2</a></span>
                                    <p>Colombia play Japan on 19 June at the Mordovia Arena, where the piling and casting operations.<a href = "{{route('news-detail',['tournamentId'=>$tournament->id])}}">Read More [+]</a></p>
                                </div>
                            </div>
                        </div>
                        <!-- End Post Item -->
